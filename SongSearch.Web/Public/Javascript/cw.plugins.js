...
(function(c){function a(aZ,aS){function a3(){if(aR.debugURLParam.test(am)){aR.debugMode=true}}this.flashVersion=8;this.debugFlash=this.debugMode=false;this.useConsole=true;this.waitForWindowLoad=this.consoleOnly=false;this.nullURL="about:blank";this.allowPolling=true;this.useFastPolling=false;this.useMovieStar=true;this.bgColor="#ffffff";this.useHighPerformance=false;this.flashLoadTimeout=1000;this.wmode=null;this.allowScriptAccess="always";this.useHTML5Audio=this.useFlashBlock=false;this.html5Test=/^probably$/i;this.ondebuglog=false;this.audioFormats={mp3:{type:['audio/mpeg; codecs="mp3"',"audio/mpeg","audio/mp3","audio/MPA","audio/mpa-robust"],required:true},mp4:{related:["aac","m4a"],type:['audio/mp4; codecs="mp4a.40.2"',"audio/aac","audio/x-m4a","audio/MP4A-LATM","audio/mpeg4-generic"],required:true},ogg:{type:["audio/ogg; codecs=vorbis"],required:false},wav:{type:['audio/wav; codecs="1"',"audio/wav","audio/wave","audio/x-wav"],required:false}};this.defaultOptions={autoLoad:false,stream:true,autoPlay:false,loops:1,onid3:null,onload:null,whileloading:null,onplay:null,onpause:null,onresume:null,whileplaying:null,onstop:null,onfailure:null,onfinish:null,onbeforefinish:null,onbeforefinishtime:5000,onbeforefinishcomplete:null,onjustbeforefinish:null,onjustbeforefinishtime:200,multiShot:true,multiShotEvents:false,position:null,pan:0,type:null,usePolicyFile:false,volume:100};this.flash9Options={isMovieStar:null,usePeakData:false,useWaveformData:false,useEQData:false,onbufferchange:null,ondataerror:null,onstats:null};this.movieStarOptions={bufferTime:3,serverURL:null,onconnect:null,bufferTimes:null,duration:null};this.version=null;this.versionNumber="V2.97a.20101010";this.movieURL=null;this.url=aZ||null;this.altURL=null;this.enabled=this.swfLoaded=false;this.o=null;this.movieID="sm2-container";this.id=aS||"sm2movie";this.swfCSS={swfBox:"sm2-object-box",swfDefault:"movieContainer",swfError:"swf_error",swfTimedout:"swf_timedout",swfUnblocked:"swf_unblocked",sm2Debug:"sm2_debug",highPerf:"high_performance",flashDebug:"flash_debug"};this.oMC=null;this.sounds={};this.soundIDs=[];this.muted=false;this.debugID="soundmanager-debug";this.debugURLParam=/([#?&])debug=1/i;this.didFlashBlock=this.specialWmodeCase=false;this.filePattern=null;this.filePatterns={flash8:/\.mp3(\?.*)?$/i,flash9:/\.mp3(\?.*)?$/i};this.baseMimeTypes=/^\s*audio\/(?:x-)?(?:mp(?:eg|3))\s*(?:$|;)/i;this.netStreamMimeTypes=/^\s*audio\/(?:x-)?(?:mp(?:eg|3))\s*(?:$|;)/i;this.netStreamTypes=["aac","flv","mov","mp4","m4v","f4v","m4a","mp4v","3gp","3g2"];this.netStreamPattern=RegExp("\\.("+this.netStreamTypes.join("|")+")(\\?.*)?$","i");this.mimePattern=this.baseMimeTypes;this.features={buffering:false,peakData:false,waveformData:false,eqData:false,movieStar:false};this.sandbox={};this.hasHTML5=null;this.html5={usingFlash:null};this.ignoreFlash=false;var u,aR=this,aH,aL=navigator.userAgent,am=c.location.href.toString(),aQ=this.flashVersion,aO=document,aP=c,a4,an,aB=[],au=false,av=false,aJ=false,ay=false,a5=false,aw,aK,a6,aC,aD,T,ao,a7,aa,az,a8,ax,aE,ab,ac,af,ad,f,d,e,ai,a0,aj=null,g=null,ap,h,aq,ag,ah,i,aI,ae=false,j=false,a1,a2,ar=null,aU,r,aA=false,ak,aF,m,aV,aG,aM,aW=Array.prototype.slice,aX=aL.match(/pre\//i),aT=aL.match(/(ipad|iphone)/i);aL.match(/mobile/i);var aN=aL.match(/MSIE/i),al=aL.match(/safari/i)&&!aL.match(/chrome/i),n=typeof aO.hasFocus!=="undefined"?aO.hasFocus():null,at=typeof aO.hasFocus==="undefined"&&al,aY=!at;this._use_maybe=am.match(/sm2\-useHTML5Maybe\=1/i);this._overHTTP=aO.location?aO.location.protocol.match(/http/i):null;this.useAltURL=!this._overHTTP;if(aT||aX){aR.useHTML5Audio=true;aR.ignoreFlash=true}if(aX||this._use_maybe){aR.html5Test=/^(probably|maybe)$/i}this.supported=function(){return ar?aJ&&!ay:aR.useHTML5Audio&&aR.hasHTML5};this.getMovie=function(k){return aN?aP[k]:al?aH(k)||aO[k]:aH(k)};this.loadFromXML=function(l){try{aR.o._loadFromXML(l)}catch(k){ai()}return true};this.createSound=function(p){function o(){k=ag(k);aR.sounds[q.id]=new u(q);aR.soundIDs.push(q.id);return aR.sounds[q.id]}var k=null,l=null,q=null;if(!aJ||!aR.supported()){i("soundManager.createSound(): "+ap(!aJ?"notReady":"notOK"));return false}if(arguments.length===2){p={id:arguments[0],url:arguments[1]}}q=k=aK(p);if(aI(q.id,true)){return aR.sounds[q.id]}if(r(q)){l=o();l._setup_html5(q)}else{if(aQ>8&&aR.useMovieStar){if(q.isMovieStar===null){q.isMovieStar=q.serverURL||(q.type?q.type.match(aR.netStreamPattern):false)||q.url.match(aR.netStreamPattern)?true:false}if(q.isMovieStar){if(q.usePeakData){q.usePeakData=false}}}q=ah(q,"soundManager.createSound(): ");l=o();if(aQ===8){aR.o._createSound(q.id,q.onjustbeforefinishtime,q.loops||1,q.usePolicyFile)}else{aR.o._createSound(q.id,q.url,q.onjustbeforefinishtime,q.usePeakData,q.useWaveformData,q.useEQData,q.isMovieStar,q.isMovieStar?q.bufferTime:false,q.loops||1,q.serverURL,q.duration||null,q.autoPlay,true,q.bufferTimes,q.onstats?true:false,q.autoLoad,q.usePolicyFile);if(!q.serverURL){l.connected=true;q.onconnect&&q.onconnect.apply(l)}}}if(q.autoLoad||q.autoPlay){if(l){if(aR.isHTML5){l.autobuffer="auto";l.preload="auto"}else{l.load(q)}}}q.autoPlay&&l.play();return l};this.destroySound=function(p,o){if(!aI(p)){return false}var k=aR.sounds[p],l;k._iO={};k.stop();k.unload();for(l=0;l<aR.soundIDs.length;l++){if(aR.soundIDs[l]===p){aR.soundIDs.splice(l,1);break}}o||k.destruct(true);delete aR.sounds[p];return true};this.load=function(l,k){if(!aI(l)){return false}return aR.sounds[l].load(k)};this.unload=function(k){if(!aI(k)){return false}return aR.sounds[k].unload()};this.start=this.play=function(l,k){if(!aJ||!aR.supported()){i("soundManager.play(): "+ap(!aJ?"notReady":"notOK"));return false}if(!aI(l)){k instanceof Object||(k={url:k});if(k&&k.url){k.id=l;return aR.createSound(k).play()}else{return false}}return aR.sounds[l].play(k)};this.setPosition=function(l,k){if(!aI(l)){return false}return aR.sounds[l].setPosition(k)};this.stop=function(k){if(!aI(k)){return false}return aR.sounds[k].stop()};this.stopAll=function(){for(var k in aR.sounds){aR.sounds[k] instanceof u&&aR.sounds[k].stop()}};this.pause=function(k){if(!aI(k)){return false}return aR.sounds[k].pause()};this.pauseAll=function(){for(var k=aR.soundIDs.length;k--;){aR.sounds[aR.soundIDs[k]].pause()}};this.resume=function(k){if(!aI(k)){return false}return aR.sounds[k].resume()};this.resumeAll=function(){for(var k=aR.soundIDs.length;k--;){aR.sounds[aR.soundIDs[k]].resume()}};this.togglePause=function(k){if(!aI(k)){return false}return aR.sounds[k].togglePause()};this.setPan=function(l,k){if(!aI(l)){return false}return aR.sounds[l].setPan(k)};this.setVolume=function(l,k){if(!aI(l)){return false}return aR.sounds[l].setVolume(k)};this.mute=function(l){var k=0;if(typeof l!=="string"){l=null}if(l){if(!aI(l)){return false}return aR.sounds[l].mute()}else{for(k=aR.soundIDs.length;k--;){aR.sounds[aR.soundIDs[k]].mute()}aR.muted=true}return true};this.muteAll=function(){aR.mute()};this.unmute=function(k){if(typeof k!=="string"){k=null}if(k){if(!aI(k)){return false}return aR.sounds[k].unmute()}else{for(k=aR.soundIDs.length;k--;){aR.sounds[aR.soundIDs[k]].unmute()}aR.muted=false}return true};this.unmuteAll=function(){aR.unmute()};this.toggleMute=function(k){if(!aI(k)){return false}return aR.sounds[k].toggleMute()};this.getMemoryUse=function(){if(aQ===8){return 0}if(aR.o){return parseInt(aR.o._getMemoryUse(),10)}};this.disable=function(l){if(typeof l==="undefined"){l=false}if(ay){return false}ay=true;for(var k=aR.soundIDs.length;k--;){e(aR.sounds[aR.soundIDs[k]])}aw(l);aM(aP,"load",aD);return true};this.canPlayMIME=function(l){var k;if(aR.hasHTML5){k=ak({type:l})}return !ar||k?k:l?l.match(aR.mimePattern)?true:false:null};this.canPlayURL=function(l){var k;if(aR.hasHTML5){k=ak(l)}return !ar||k?k:l?l.match(aR.filePattern)?true:false:null};this.canPlayLink=function(k){if(typeof k.type!=="undefined"&&k.type){if(aR.canPlayMIME(k.type)){return true}}return aR.canPlayURL(k.href)};this.getSoundById=function(k){if(!k){throw Error("SoundManager.getSoundById(): sID is null/undefined")}return aR.sounds[k]};this.onready=function(l,k){if(l&&l instanceof Function){k||(k=aP);a6(l,k);aC();return true}else{throw ap("needFunction")}};this.getMoviePercent=function(){return aR.o&&typeof aR.o.PercentLoaded!=="undefined"?aR.o.PercentLoaded():null};this._wD=this._writeDebug=function(o,l,k){aR.ondebuglog&&aR.ondebuglog(o,l,k);return true};this._debug=function(){};this.reboot=function(){for(var l=aR.soundIDs.length;l--;){aR.sounds[aR.soundIDs[l]].destruct()}try{if(aN){g=aR.o.innerHTML}aj=aR.o.parentNode.removeChild(aR.o)}catch(k){}g=aj=null;aR.enabled=aJ=ae=j=au=av=ay=aR.swfLoaded=false;aR.soundIDs=aR.sounds=[];aR.o=null;for(l=aB.length;l--;){aB[l].fired=false}aP.setTimeout(function(){aR.beginDelayedInit()},20)};this.destruct=function(){aR.disable(true)};this.beginDelayedInit=function(){a5=true;aE();setTimeout(a8,20);ao()};u=function(s){var q=this,v,l,t,o,p,k;this.sID=s.id;this.url=s.url;this._iO=this.instanceOptions=this.options=aK(s);this.pan=this.options.pan;this.volume=this.options.volume;this._lastURL=null;this.isHTML5=false;this.id3={};this._debug=function(){};this._debug();this.load=function(y){var w=null;if(typeof y!=="undefined"){q._iO=aK(y);q.instanceOptions=q._iO}else{y=q.options;q._iO=y;q.instanceOptions=q._iO;if(q._lastURL&&q._lastURL!==q.url){q._iO.url=q.url;q.url=null}}if(q._iO.url===q.url&&q.readyState!==0&&q.readyState!==2){return q}q._lastURL=q.url;q.loaded=false;q.readyState=1;q.playState=0;if(r(q._iO)){w=q._setup_html5(q._iO);w.load();q._iO.autoPlay&&q.play()}else{try{q.isHTML5=false;q._iO=ah(ag(q._iO));aQ===8?aR.o._load(q.sID,q._iO.url,q._iO.stream,q._iO.autoPlay,q._iO.whileloading?1:0,q._iO.loops||1,q._iO.usePolicyFile):aR.o._load(q.sID,q._iO.url,q._iO.stream?true:false,q._iO.autoPlay?true:false,q._iO.loops||1,q._iO.autoLoad?true:false,q._iO.usePolicyFile)}catch(x){ad()}}return q};this.unload=function(){if(q.readyState!==0){if(q.isHTML5){t();if(k){k.pause();k.src=aR.nullURL;k.load();k=q._audio=null}}else{aQ===8?aR.o._unload(q.sID,aR.nullURL):aR.o._unload(q.sID)}v()}return q};this.destruct=function(w){if(q.isHTML5){t();if(k){k.pause();k.src="about:blank";k.load();k=q._audio=null}}else{q._iO.onfailure=null;aR.o._destroySound(q.sID)}w||aR.destroySound(q.sID,true)};this.start=this.play=function(y,w){var x;w=typeof w==="undefined"?true:w;y||(y={});q._iO=aK(y,q._iO);q._iO=aK(q._iO,q.options);q.instanceOptions=q._iO;if(q._iO.serverURL){if(!q.connected){q.getAutoPlay()||q.setAutoPlay(true);return q}}if(r(q._iO)){q._setup_html5(q._iO);o()}if(q.playState===1&&!q.paused){if(x=q._iO.multiShot){q.isHTML5&&q.setPosition(q._iO.position)}else{return q}}if(!q.loaded){if(q.readyState===0){if(q.isHTML5){q.load(q._iO);q.readyState=1}else{if(!q._iO.serverURL){q._iO.autoPlay=true;q.load(q._iO)}}}else{if(q.readyState===2){return q}}}if(q.paused&&q.position&&q.position>0){q.resume()}else{q.playState=1;q.paused=false;if(!q.instanceCount||q._iO.multiShotEvents||aQ>8&&!q.isHTML5&&!q.getAutoPlay()){q.instanceCount++}q.position=typeof q._iO.position!=="undefined"&&!isNaN(q._iO.position)?q._iO.position:0;q._iO=ah(ag(q._iO));q._iO.onplay&&w&&q._iO.onplay.apply(q);q.setVolume(q._iO.volume,true);q.setPan(q._iO.pan,true);if(q.isHTML5){o();q._setup_html5().play()}else{aR.o._start(q.sID,q._iO.loops||1,aQ===9?q.position:q.position/1000)}}return q};this.stop=function(w){if(q.playState===1){q._onbufferchange(0);q.resetOnPosition(0);if(!q.isHTML5){q.playState=0}q.paused=false;q._iO.onstop&&q._iO.onstop.apply(q);if(q.isHTML5){if(k){q.setPosition(0);k.pause();q.playState=0;q._onTimer();t();q.unload()}}else{aR.o._stop(q.sID,w);q._iO.serverURL&&q.unload()}q.instanceCount=0;q._iO={}}return q};this.setAutoPlay=function(w){q._iO.autoPlay=w;aR.o._setAutoPlay(q.sID,w);w&&!q.instanceCount&&q.readyState===1&&q.instanceCount++};this.getAutoPlay=function(){return q._iO.autoPlay};this.setPosition=function(w){if(w===undefined){w=0}q.position=q.isHTML5?Math.max(w,0):Math.min(q.duration||q._iO.duration,Math.max(w,0));q.resetOnPosition(q.position);if(q.isHTML5){if(k){if(q.playState){try{k.currentTime=q.position/1000}catch(x){}}if(q.paused){q._onTimer(true);q._iO.useMovieStar&&q.resume()}}}else{w=aQ===9?q.position:q.position/1000;q.playState===0?q.play({position:w}):aR.o._setPosition(q.sID,w,q.paused||!q.playState)}return q};this.pause=function(w){if(q.paused||q.playState===0&&q.readyState!==1){return q}q.paused=true;if(q.isHTML5){q._setup_html5().pause();t()}else{if(w||w===undefined){aR.o._pause(q.sID)}}q._iO.onpause&&q._iO.onpause.apply(q);return q};this.resume=function(){if(!q.paused){return q}q.paused=false;q.playState=1;if(q.isHTML5){q._setup_html5().play();o()}else{aR.o._pause(q.sID)}q._iO.onresume&&q._iO.onresume.apply(q);return q};this.togglePause=function(){if(q.playState===0){q.play({position:aQ===9&&!q.isHTML5?q.position:q.position/1000});return q}q.paused?q.resume():q.pause();return q};this.setPan=function(w,x){if(typeof w==="undefined"){w=0}if(typeof x==="undefined"){x=false}q.isHTML5||aR.o._setPan(q.sID,w);q._iO.pan=w;if(!x){q.pan=w}return q};this.setVolume=function(w,x){if(typeof w==="undefined"){w=100}if(typeof x==="undefined"){x=false}if(q.isHTML5){if(k){k.volume=w/100}}else{aR.o._setVolume(q.sID,aR.muted&&!q.muted||q.muted?0:w)}q._iO.volume=w;if(!x){q.volume=w}return q};this.mute=function(){q.muted=true;if(q.isHTML5){if(k){k.muted=true}}else{aR.o._setVolume(q.sID,0)}return q};this.unmute=function(){q.muted=false;var w=typeof q._iO.volume!=="undefined";if(q.isHTML5){if(k){k.muted=false}}else{aR.o._setVolume(q.sID,w?q._iO.volume:q.options.volume)}return q};this.toggleMute=function(){return q.muted?q.unmute():q.mute()};this.onposition=function(y,w,x){q._onPositionItems.push({position:y,method:w,scope:typeof x!=="undefined"?x:q,fired:false});return q};this.processOnPosition=function(){var w,x;w=q._onPositionItems.length;if(!w||!q.playState||q._onPositionFired>=w){return false}for(w=w;w--;){x=q._onPositionItems[w];if(!x.fired&&q.position>=x.position){x.method.apply(x.scope,[x.position]);x.fired=true;aR._onPositionFired++}}return true};this.resetOnPosition=function(y){var w,x;w=q._onPositionItems.length;if(!w){return false}for(w=w;w--;){x=q._onPositionItems[w];if(x.fired&&y<=x.position){x.fired=false;aR._onPositionFired--}}return true};this._onTimer=function(w){var x={};if(q._hasTimer||w){if(k&&(w||(q.playState>0||q.readyState===1)&&!q.paused)){q.duration=p();q.durationEstimate=q.duration;w=k.currentTime?k.currentTime*1000:0;q._whileplaying(w,x,x,x,x);return true}else{return false}}};p=function(){var w=k?k.duration*1000:undefined;return w&&!isNaN(w)?w:null};o=function(){q.isHTML5&&a1(q)};t=function(){q.isHTML5&&a2(q)};v=function(){q._onPositionItems=[];q._onPositionFired=0;q._hasTimer=null;q._added_events=null;k=q._audio=null;q.bytesLoaded=null;q.bytesTotal=null;q.position=null;q.duration=q._iO&&q._iO.duration?q._iO.duration:null;q.durationEstimate=null;q.failures=0;q.loaded=false;q.playState=0;q.paused=false;q.readyState=0;q.muted=false;q.didBeforeFinish=false;q.didJustBeforeFinish=false;q.isBuffering=false;q.instanceOptions={};q.instanceCount=0;q.peakData={left:0,right:0};q.waveformData={left:[],right:[]};q.eqData=[];q.eqData.left=[];q.eqData.right=[]};v();this._setup_html5=function(w){w=aK(q._iO,w);if(k){if(q.url!==w.url){k.src=w.url}}else{q._audio=new Audio(w.url);k=q._audio;q.isHTML5=true;l()}k.loop=w.loops>1?"loop":"";return q._audio};l=function(){function w(x,y,z){return k?k.addEventListener(x,y,z||false):null}if(q._added_events){return false}q._added_events=true;w("load",function(){if(k){q._onbufferchange(0);q._whileloading(q.bytesTotal,q.bytesTotal,p());q._onload(true)}},false);w("canplay",function(){q._onbufferchange(0)},false);w("waiting",function(){q._onbufferchange(1)},false);w("progress",function(x){if(!q.loaded&&k){q._onbufferchange(0);q._whileloading(x.loaded||0,x.total||1,p())}},false);w("error",function(){k&&q._onload(false)},false);w("loadstart",function(){q._onbufferchange(1)},false);w("play",function(){q._onbufferchange(0)},false);w("playing",function(){q._onbufferchange(0)},false);w("timeupdate",function(){q._onTimer()},false);setTimeout(function(){q&&k&&w("ended",function(){q._onfinish()},false)},250);return true};this._whileloading=function(y,w,x,z){q.bytesLoaded=y;q.bytesTotal=w;q.duration=Math.floor(x);q.bufferLength=z;if(q._iO.isMovieStar){q.durationEstimate=q.duration}else{q.durationEstimate=q._iO.duration?q.duration>q._iO.duration?q.duration:q._iO.duration:parseInt(q.bytesTotal/q.bytesLoaded*q.duration,10);if(q.durationEstimate===undefined){q.durationEstimate=q.duration}q.bufferLength=z}q.readyState!==3&&q._iO.whileloading&&q._iO.whileloading.apply(q)};this._onid3=function(z,w){var x=[],A,y;A=0;for(y=z.length;A<y;A++){x[z[A]]=w[A]}q.id3=aK(q.id3,x);q._iO.onid3&&q._iO.onid3.apply(q)};this._whileplaying=function(z,w,x,A,y){if(isNaN(z)||z===null){return false}if(q.playState===0&&z>0){z=0}q.position=z;q.processOnPosition();if(aQ>8&&!q.isHTML5){if(q._iO.usePeakData&&typeof w!=="undefined"&&w){q.peakData={left:w.leftPeak,right:w.rightPeak}}if(q._iO.useWaveformData&&typeof x!=="undefined"&&x){q.waveformData={left:x.split(","),right:A.split(",")}}if(q._iO.useEQData){if(typeof y!=="undefined"&&y&&y.leftEQ){z=y.leftEQ.split(",");q.eqData=z;q.eqData.left=z;if(typeof y.rightEQ!=="undefined"&&y.rightEQ){q.eqData.right=y.rightEQ.split(",")}}}}if(q.playState===1){!q.isHTML5&&aR.flashVersion===8&&!q.position&&q.isBuffering&&q._onbufferchange(0);q._iO.whileplaying&&q._iO.whileplaying.apply(q);if((q.loaded||!q.loaded&&q._iO.isMovieStar)&&q._iO.onbeforefinish&&q._iO.onbeforefinishtime&&!q.didBeforeFinish&&q.duration-q.position<=q._iO.onbeforefinishtime){q._onbeforefinish()}}return true};this._onconnect=function(w){w=w===1;if(q.connected=w){q.failures=0;q._iO.onconnect&&q._iO.onconnect.apply(q,[w]);if(aI(q.sID)&&(q.options.autoLoad||q.getAutoPlay())){q.play(undefined,q.getAutoPlay())}}};this._onload=function(w){w=w?true:false;q.loaded=w;q.readyState=w?3:2;q._onbufferchange(0);q._iO.onload&&q._iO.onload.apply(q,[w]);return true};this._onfailure=function(y,w,x){q.failures++;q._iO.onfailure&&q.failures===1&&q._iO.onfailure(q,y,w,x)};this._onbeforefinish=function(){if(!q.didBeforeFinish){q.didBeforeFinish=true;q._iO.onbeforefinish&&q._iO.onbeforefinish.apply(q)}};this._onjustbeforefinish=function(){if(!q.didJustBeforeFinish){q.didJustBeforeFinish=true;q._iO.onjustbeforefinish&&q._iO.onjustbeforefinish.apply(q)}};this._onstats=function(w){q._iO.onstats&&q._iO.onstats(q,w)};this._onfinish=function(){q._onbufferchange(0);q.resetOnPosition(0);q._iO.onbeforefinishcomplete&&q._iO.onbeforefinishcomplete.apply(q);q.didBeforeFinish=false;q.didJustBeforeFinish=false;if(q.instanceCount){q.instanceCount--;if(!q.instanceCount){q.playState=0;q.paused=false;q.instanceCount=0;q.instanceOptions={};t()}if(!q.instanceCount||q._iO.multiShotEvents){q._iO.onfinish&&q._iO.onfinish.apply(q)}}};this._onbufferchange=function(w){if(q.playState===0){return false}if(w&&q.isBuffering||!w&&!q.isBuffering){return false}q.isBuffering=w===1;q._iO.onbufferchange&&q._iO.onbufferchange.apply(q);return true};this._ondataerror=function(){q.playState>0&&q._iO.ondataerror&&q._iO.ondataerror.apply(q)}};ac=function(){return aO.body?aO.body:aO._docElement?aO.documentElement:aO.getElementsByTagName("div")[0]};aH=function(k){return aO.getElementById(k)};aK=function(p,o){var k={},l,q;for(l in p){if(p.hasOwnProperty(l)){k[l]=p[l]}}l=typeof o==="undefined"?aR.defaultOptions:o;for(q in l){if(l.hasOwnProperty(q)&&typeof k[q]==="undefined"){k[q]=l[q]}}return k};(function(){function p(q){q=aW.call(q);var s=q.length;if(k){q[1]="on"+q[1];s>3&&q.pop()}else{s===3&&q.push(false)}return q}function o(t,q){var s=t.shift()[l[q]];k?s(t[0],t[1]):s.apply(this,t)}var k=aP.attachEvent,l={add:k?"attachEvent":"addEventListener",remove:k?"detachEvent":"removeEventListener"};aG=function(){o(p(arguments),"add")};aM=function(){o(p(arguments),"remove")}})();r=function(k){return(k.type?ak({type:k.type}):false)||ak(k.url)};ak=function(o){if(!aR.useHTML5Audio||!aR.hasHTML5){return false}var l,k=aR.audioFormats;if(!aF){aF=[];for(l in k){if(k.hasOwnProperty(l)){aF.push(l);if(k[l].related){aF=aF.concat(k[l].related)}}}aF=RegExp("\\.("+aF.join("|")+")","i")}l=typeof o.type!=="undefined"?o.type:null;o=typeof o==="string"?o.toLowerCase().match(aF):null;if(!o||!o.length){if(!l){return false}}else{o=o[0].substr(1)}if(o&&typeof aR.html5[o]!=="undefined"){return aR.html5[o]}else{if(!l){if(o&&aR.html5[o]){return aR.html5[o]}else{l="audio/"+o}}l=aR.html5.canPlayType(l);return aR.html5[o]=l}};aV=function(){function p(x){var t,w,v=false;if(!o||typeof o.canPlayType!=="function"){return false}if(x instanceof Array){t=0;for(w=x.length;t<w&&!v;t++){if(aR.html5[x[t]]||o.canPlayType(x[t]).match(aR.html5Test)){v=true;aR.html5[x[t]]=true}}return v}else{return(x=o&&typeof o.canPlayType==="function"?o.canPlayType(x):false)&&(x.match(aR.html5Test)?true:false)}}if(!aR.useHTML5Audio||typeof Audio==="undefined"){return false}var o=typeof Audio!=="undefined"?new Audio:null,s,k={},q,l;q=aR.audioFormats;for(s in q){if(q.hasOwnProperty(s)){k[s]=p(q[s].type);if(q[s]&&q[s].related){for(l=0;l<q[s].related.length;l++){aR.html5[q[s].related[l]]=k[s]}}}}k.canPlayType=o?p:null;aR.html5=aK(aR.html5,k);return true};aH=function(k){return aO.getElementById(k)};ap=function(){};ag=function(k){if(aQ===8&&k.loops>1&&k.stream){k.stream=false}return k};ah=function(k){if(k&&!k.usePolicyFile&&(k.onid3||k.usePeakData||k.useWaveformData||k.useEQData)){k.usePolicyFile=true}return k};i=function(k){typeof console!=="undefined"&&typeof console.warn!=="undefined"&&console.warn(k)};a4=function(){return false};e=function(l){for(var k in l){if(l.hasOwnProperty(k)&&typeof l[k]==="function"){l[k]=a4}}};ai=function(k){if(typeof k==="undefined"){k=false}if(ay||k){aR.disable(k)}};a0=function(l){var k=null;if(l){if(l.match(/\.swf(\?\.*)?$/i)){if(k=l.substr(l.toLowerCase().lastIndexOf(".swf?")+4)){return l}}else{if(l.lastIndexOf("/")!==l.length-1){l+="/"}}}return(l&&l.lastIndexOf("/")!==-1?l.substr(0,l.lastIndexOf("/")+1):"./")+aR.movieURL};aa=function(){if(aQ!==8&&aQ!==9){aR.flashVersion=8}var k=aR.debugMode||aR.debugFlash?"_debug.swf":".swf";if(aR.flashVersion<9&&aR.useHTML5Audio&&aR.audioFormats.mp4.required){aR.flashVersion=9}aQ=aR.flashVersion;aR.version=aR.versionNumber+(aA?" (HTML5-only mode)":aQ===9?" (AS3/Flash 9)":" (AS2/Flash 8)");if(aQ>8){aR.defaultOptions=aK(aR.defaultOptions,aR.flash9Options);aR.features.buffering=true}if(aQ>8&&aR.useMovieStar){aR.defaultOptions=aK(aR.defaultOptions,aR.movieStarOptions);aR.filePatterns.flash9=RegExp("\\.(mp3|"+aR.netStreamTypes.join("|")+")(\\?.*)?$","i");aR.mimePattern=aR.netStreamMimeTypes;aR.features.movieStar=true}else{aR.features.movieStar=false}aR.filePattern=aR.filePatterns[aQ!==8?"flash9":"flash8"];aR.movieURL=(aQ===8?"soundmanager2.swf":"soundmanager2_flash9.swf").replace(".swf",k);aR.features.peakData=aR.features.waveformData=aR.features.eqData=aQ>8};d=function(l,k){if(!aR.o||!aR.allowPolling){return false}aR.o._setPolling(l,k)};(function(){function p(q){q=aW.call(q);var s=q.length;if(k){q[1]="on"+q[1];s>3&&q.pop()}else{s===3&&q.push(false)}return q}function o(t,q){var s=t.shift()[l[q]];k?s(t[0],t[1]):s.apply(this,t)}var k=aP.attachEvent,l={add:k?"attachEvent":"addEventListener",remove:k?"detachEvent":"removeEventListener"};aG=function(){o(p(arguments),"add")};aM=function(){o(p(arguments),"remove")}})();f=function(){function o(){k.left=aP.scrollX+"px";k.top=aP.scrollY+"px"}function l(p){p=aP[(p?"add":"remove")+"EventListener"];p("resize",o,false);p("scroll",o,false)}var k=null;return{check:function(p){k=aR.oMC.style;if(aL.match(/android/i)){if(p){if(aR.flashLoadTimeout){aR._s.flashLoadTimeout=0}return false}k.position="absolute";k.left=k.top="0px";l(true);aR.onready(function(){l(false);if(k){k.left=k.top="-9999px"}});o()}return true}}}();af=function(t,s){var x=s?s:aR.url,l=aR.altURL?aR.altURL:x,w;w=ac();var o,q,k=aq(),v,y=null;y=(y=aO.getElementsByTagName("html")[0])&&y.dir&&y.dir.match(/rtl/i);t=typeof t==="undefined"?aR.id:t;if(au&&av){return false}if(aA){aa();aR.oMC=aH(aR.movieID);an();av=au=true;return false}au=true;aa();aR.url=a0(this._overHTTP?x:l);s=aR.url;aR.wmode=!aR.wmode&&aR.useHighPerformance&&!aR.useMovieStar?"transparent":aR.wmode;if(aR.wmode!==null&&!aN&&!aR.useHighPerformance&&navigator.platform.match(/win32/i)){aR.specialWmodeCase=true;aR.wmode=null}w={name:t,id:t,src:s,width:"100%",height:"100%",quality:"high",allowScriptAccess:aR.allowScriptAccess,bgcolor:aR.bgColor,pluginspage:"http://www.macromedia.com/go/getflashplayer",type:"application/x-shockwave-flash",wmode:aR.wmode};if(aR.debugFlash){w.FlashVars="debug=1"}aR.wmode||delete w.wmode;if(aN){x=aO.createElement("div");q='<object id="'+t+'" data="'+s+'" type="'+w.type+'" width="'+w.width+'" height="'+w.height+'"><param name="movie" value="'+s+'" /><param name="AllowScriptAccess" value="'+aR.allowScriptAccess+'" /><param name="quality" value="'+w.quality+'" />'+(aR.wmode?'<param name="wmode" value="'+aR.wmode+'" /> ':"")+'<param name="bgcolor" value="'+aR.bgColor+'" />'+(aR.debugFlash?'<param name="FlashVars" value="'+w.FlashVars+'" />':"")+"<!-- --></object>"}else{x=aO.createElement("embed");for(o in w){w.hasOwnProperty(o)&&x.setAttribute(o,w[o])}}a3();k=aq();if(w=ac()){aR.oMC=aH(aR.movieID)?aH(aR.movieID):aO.createElement("div");if(aR.oMC.id){v=aR.oMC.className;aR.oMC.className=(v?v+" ":aR.swfCSS.swfDefault)+(k?" "+k:"");aR.oMC.appendChild(x);if(aN){o=aR.oMC.appendChild(aO.createElement("div"));o.className=aR.swfCSS.swfBox;o.innerHTML=q}av=true;f.check(true)}else{aR.oMC.id=aR.movieID;aR.oMC.className=aR.swfCSS.swfDefault+" "+k;o=k=null;if(!aR.useFlashBlock){if(aR.useHighPerformance){k={position:"fixed",width:"8px",height:"8px",bottom:"0px",left:"0px",overflow:"hidden"}}else{k={position:"absolute",width:"6px",height:"6px",top:"-9999px",left:"-9999px"};if(y){k.left=Math.abs(parseInt(k.left,10))+"px"}}}if(aL.match(/webkit/i)){aR.oMC.style.zIndex=10000}if(!aR.debugFlash){for(v in k){if(k.hasOwnProperty(v)){aR.oMC.style[v]=k[v]}}}try{aN||aR.oMC.appendChild(x);w.appendChild(aR.oMC);if(aN){o=aR.oMC.appendChild(aO.createElement("div"));o.className=aR.swfCSS.swfBox;o.innerHTML=q}av=true}catch(p){throw Error(ap("appXHTML"))}f.check()}}return true};aI=this.getSoundById;ax=function(){if(aA){af();return false}if(aR.o){return false}aR.o=aR.getMovie(aR.id);if(!aR.o){if(aj){if(aN){aR.oMC.innerHTML=g}else{aR.oMC.appendChild(aj)}aj=null;au=true}else{af(aR.id,aR.url)}aR.o=aR.getMovie(aR.id)}aR.oninitmovie instanceof Function&&setTimeout(aR.oninitmovie,1);return true};T=function(k){if(k){aR.url=k}ax()};ao=function(){setTimeout(a7,500)};a7=function(){if(ae){return false}ae=true;aM(aP,"load",ao);if(at&&!n){return false}var k;aJ||(k=aR.getMoviePercent());setTimeout(function(){k=aR.getMoviePercent();if(!aJ&&aY){if(k===null){if(aR.useFlashBlock||aR.flashLoadTimeout===0){aR.useFlashBlock&&h()}else{ai(true)}}else{aR.flashLoadTimeout!==0&&ai(true)}}},aR.flashLoadTimeout)};T=function(k){if(k){aR.url=k}ax()};aq=function(){var k=[];aR.debugMode&&k.push(aR.swfCSS.sm2Debug);aR.debugFlash&&k.push(aR.swfCSS.flashDebug);aR.useHighPerformance&&k.push(aR.swfCSS.highPerf);return k.join(" ")};h=function(){ap("fbHandler");var k=aR.getMoviePercent();if(aR.supported()){if(aR.oMC){aR.oMC.className=aq()+" "+aR.swfCSS.swfDefault+(" "+aR.swfCSS.swfUnblocked)}}else{if(ar){aR.oMC.className=aq()+" "+aR.swfCSS.swfDefault+" "+(k===null?aR.swfCSS.swfTimedout:aR.swfCSS.swfError)}aR.didFlashBlock=true;aC(true);aR.onerror instanceof Function&&aR.onerror.apply(aP)}};az=function(){function k(){aM(aP,"focus",az);aM(aP,"load",az)}if(n||!at){k();return true}n=aY=true;al&&at&&aM(aP,"mousemove",az);ae=false;k();return true};aw=function(k){if(aJ){return false}if(aA){aJ=true;aC();aD();return true}aR.useFlashBlock&&aR.flashLoadTimeout&&!aR.getMoviePercent()||(aJ=true);if(ay||k){if(aR.useFlashBlock){aR.oMC.className=aq()+" "+(aR.getMoviePercent()===null?aR.swfCSS.swfTimedout:aR.swfCSS.swfError)}aC();aR.onerror instanceof Function&&aR.onerror.apply(aP);return false}if(aR.waitForWindowLoad&&!a5){aG(aP,"load",aD);return false}else{aD()}return true};a6=function(l,k){aB.push({method:l,scope:k||null,fired:false})};aC=function(p){if(!aJ&&!p){return false}p={success:p?aR.supported():!ay};var o=[],k,l,q=!aR.useFlashBlock||aR.useFlashBlock&&!aR.supported();k=0;for(l=aB.length;k<l;k++){aB[k].fired!==true&&o.push(aB[k])}if(o.length){k=0;for(l=o.length;k<l;k++){o[k].scope?o[k].method.apply(o[k].scope,[p]):o[k].method(p);if(!q){o[k].fired=true}}}return true};aD=function(){aP.setTimeout(function(){aR.useFlashBlock&&h();aC();aR.onload instanceof Function&&aR.onload.apply(aP);aR.waitForWindowLoad&&aG(aP,"load",aD)},1)};aU=function(){var o,l,k=!am.match(/usehtml5audio/i)&&!am.match(/sm2\-ignorebadua/i)&&al&&aL.match(/OS X 10_6_(3|4)/i);if(aL.match(/iphone os (1|2|3_0|3_1)/i)?true:false){aR.hasHTML5=false;aA=true;if(aR.oMC){aR.oMC.style.display="none"}return false}if(aR.useHTML5Audio){if(!aR.html5||!aR.html5.canPlayType){aR.hasHTML5=false;return true}else{aR.hasHTML5=true}if(k){aR.useHTML5Audio=false;aR.hasHTML5=false;return true}}else{return true}for(l in aR.audioFormats){if(aR.audioFormats.hasOwnProperty(l)&&aR.audioFormats[l].required&&!aR.html5.canPlayType(aR.audioFormats[l].type)){o=true}}if(aR.ignoreFlash){o=false}aA=aR.useHTML5Audio&&aR.hasHTML5&&!o;return o};an=function(){var o,l=[];if(aJ){return false}if(aR.hasHTML5){for(o in aR.audioFormats){aR.audioFormats.hasOwnProperty(o)&&l.push(o+": "+aR.html5[o])}}if(aA){if(!aJ){aM(aP,"load",aR.beginDelayedInit);aR.enabled=true;aw()}return true}ax();try{aR.o._externalInterfaceTest(false);if(aR.allowPolling){d(true,aR.useFastPolling?true:false)}aR.debugMode||aR.o._disableDebug();aR.enabled=true}catch(k){ai(true);aw();return false}aw();aM(aP,"load",aR.beginDelayedInit);return true};a8=function(){if(j){return false}af();ax();return j=true};aE=function(){if(ab){return false}ab=true;a3();aV();aR.html5.usingFlash=aU();ar=aR.html5.usingFlash;ab=true;aO.removeEventListener&&aO.removeEventListener("DOMContentLoaded",aE,false);T();return true};a1=function(k){if(!k._hasTimer){k._hasTimer=true}};a2=function(k){if(k._hasTimer){k._hasTimer=false}};ad=function(){aR.onerror instanceof Function&&aR.onerror();aR.disable()};this._setSandboxType=function(){};this._externalInterfaceOK=function(){if(aR.swfLoaded){return false}(new Date).getTime();aR.swfLoaded=true;at=false;aN?setTimeout(an,100):an()};m=function(){if(aO.readyState==="complete"){aE();aO.detachEvent("onreadystatechange",m)}return true};if(!aR.hasHTML5||ar){aG(aP,"focus",az);aG(aP,"load",az);aG(aP,"load",ao);al&&at&&aG(aP,"mousemove",az)}if(aO.addEventListener){aO.addEventListener("DOMContentLoaded",aE,false)}else{aO.attachEvent?aO.attachEvent("onreadystatechange",m):ad()}aO.readyState==="complete"&&setTimeout(aE,100)}var b=null;if(typeof SM2_DEFER==="undefined"||!SM2_DEFER){b=new a}c.SoundManager=a;c.soundManager=b})(window);
