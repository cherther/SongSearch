...
<div id="content" class="cw-outl cw-fill-lite cw-padded cw-rounded-corners-bottom">
	...
	<div class="cw-outl-thick cw-fill-white cw-padded cw-rounded-corners text-top">
		<h2 style="display:inline;">Log in</h2> using your e-mail address and WorldSongNet.com password you've set up previously. <%: Html.ActionLink("Register", MVC.Account.Register())%> if you don't have an account.
		<div>&nbsp;</div>
