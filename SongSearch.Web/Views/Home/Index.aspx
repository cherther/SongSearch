...
<%--		<div class="cw-outl cw-fill  cw-padded cw-rounded-corners">
			...
			<ul class="cw-bullet">
				...
				<ul class="cw-bullet"><li>Catalog admins and pluggers now have the option to append their signature to the embedded title metadata of any mp3s their users download or include in a zip file</li></ul>
				</li>
		...
		<ul class="cw-bullet">
			...
			<ul class="cw-bullet"><li>For space and logic reasons, accessible from Admin/Catalog Management/Song list only</li></ul>
			</li>
