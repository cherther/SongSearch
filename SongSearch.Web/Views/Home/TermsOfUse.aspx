...
<div id="content" class="cw-outl cw-padded cw-rounded-corners-bottom">
	...
	<h2><%: Model.PageTitle %></h2>
		...
		<h3>
			Content and Services Available on the Site
		</h3>
			<p>
			We may make certain content and services available to visitors, registrants and subscribers of the Site.  For example, you may be able to read news, articles, interviews and other content and/or search, browse, preview, view song information, download music, request quotes for music licenses, negotiate agreements with catalog representatives, obtain quotes and/or licenses to use specified music for certain discrete purposes, monitor your account with us, invite and give other users administrative access to your music, post your company logo and/or personal contact information for other users to view, and browse through an online catalog of items available for purchase through our affiliates (the access to the content and the services provided are collectively referred to herein as the "Site").
			</p>
