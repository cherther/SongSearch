...
<div id="content" class="cw-outl cw-padded cw-rounded-corners-bottom">
	...
	<h2><%: Model.PageTitle %></h2>
		...
		<h3>Non-exclusive Rights</h3>
			<p>
            Our partner JS Publishing, LLC (“JSP”) will have the non-exclusive right but not the obligation to represent and market the music that you include on the Site in all media now known or hereafter devised throughout the world. Should JSP find a placement opportunity for your music or a third party’s music that you have invited into the Site, JSP will contact you or the third party directly and negotiate in good faith what participation (if any) JSP will be due from such licensing and/or exploitation opportunity. 
			</p>
